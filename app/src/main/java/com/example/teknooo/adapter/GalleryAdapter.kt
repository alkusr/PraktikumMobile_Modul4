package com.example.teknooo.adapter
...
import com.example.teknooo.ui.gallery.GalleryActivity
import com.example.teknooo.ui.gallery.GalleryViewModel
...
class GalleryAdapter(
    ...
    class GalleryViewHolder(val view: View) : RecyclerView.ViewHolder(view){
        ...
        val genreText: TextView = view.findViewById(R.id.sub_gambar_gallery)
    }
    ...
    override fun onBindViewHolder(holder: GalleryViewHolder, position: Int) {
        ...
        holder.genreText.text = context.resources.getString(item.subResourceId)
        ...
        holder.view.setOnClickListener{
            ...
            val intent = Intent(context, GalleryActivity::class.java).apply {
                ...
                putExtra("sub", viewModel.genre.value)
            }
